...
POLICY_CATALOG: dict[str, PolicyDocument] = {
    ...
    "HC-PC-006-AR": PolicyDocument(
        ...
        pdf_filename="06_disciplinary_ar.pdf",
        language="ar",
        markdown_filename="06_disciplinary.md",
        topics=["الغياب غير المصرّح به", "سوء السلوك الجسيم", "الإيقاف", "التظلم"],
        topic_key="disciplinary",
        quick_link_section="HC-PC-006 Section 6.4",
    ),
    "HC-PC-007-AR": PolicyDocument(
        code="HC-PC-007-AR",
        title="التعريفات والدرجات وكيفية قراءة هذه المدونة",
        pdf_filename="07_definitions_ar.pdf",
        language="ar",
        markdown_filename="07_definitions.md",
        topics=["نطاقات الدرجات", "تعريفات الأيام", "الخدمة المتصلة", "سجل النماذج"],
        topic_key="definitions",
        quick_link_section="HC-PC-007 Section 7.6",
    ),
    "HC-PC-008-AR": PolicyDocument(
        code="HC-PC-008-AR",
        title="سياسة الجدارة وإدارة الأداء",
        pdf_filename="08_capability_ar.pdf",
        language="ar",
        markdown_filename="08_capability.md",
        topics=["الجدارة الطبية", "تحسين الأداء", "التظلم"],
        topic_key="capability",
        quick_link_section="HC-PC-008 Section 8.2",
    ),
    "HC-PC-009-AR": PolicyDocument(
        code="HC-PC-009-AR",
        title="سياسة التظلمات والاعتراضات",
        pdf_filename="09_grievance_ar.pdf",
        language="ar",
        markdown_filename="09_grievance.md",
        topics=["تقديم التظلم", "الاعتراضات", "الحماية من الإضرار"],
        topic_key="grievance",
        quick_link_section="HC-PC-009 Section 9.2",
    ),
